...
public class Assembler {
    ...
    int LC;
    File f=new File(".//result//ObjCode.txt");
    ...
    void Initialize() {
        ...
        instr[0]=new Ins();
        try {
            CustScanner regi = new CustScanner(new File(".//res//reg.tbl"));
            CustScanner inst = new CustScanner(new File(".//res//inst.tbl"));
            while (regi.hasNext()) {
                reg[i]=new Reg();
    ...
    void Symbol_Print() {
        ...
        try {
            SymbolSave= new FileOutputStream("./result/symbol.txt");
            System.out.printf("\n* symbolTbl Table *\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            CustScanner in = new CustScanner(new File(".//res//test1.asm"));
            ...
            asm.Symbol_Print();
            in = new CustScanner(new File(".//res//test1.asm"));
            asm.LC = 0;
            System.out.printf("\nPass2:\n");
            asm.f.delete();
            while (true) {
